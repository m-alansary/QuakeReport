        ...
        try {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                if(place.contains("of")) {
                    ...
                    primary = place.substring(0, index + 2);
                    offset = place.substring(index + 3, place.length() - 1);
                }
                else {
                    primary = place;
                    offset = "Near the";
                ...
                Earthquake earthquake = new Earthquake(primary, offset, date, mag, time);
